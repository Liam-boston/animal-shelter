...
public class PetDetailView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selected = (Pet) getIntent().getSerializableExtra("selected_pet");
        ...
        this.adoptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // remove selected Pet from db
                db.collection("pets").document(selected.getName()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Intent intent = new Intent(PetDetailView.this, MainActivity.class);
                        //  intent.putExtra("thank_you", "Thank you for adopting " + selected.getName() + "! We know they're going to a great home, please keep in touch!");
                        startActivity(intent);

                        Toast.makeText(getApplicationContext(), "Returned successfully.", Toast.LENGTH_SHORT).show();
                        Log.d("SUCCESS", selected.getName() + " successfully adopted!");
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d("FAIL", "Error deleting document", e);
                    }
                });
            }
        });
